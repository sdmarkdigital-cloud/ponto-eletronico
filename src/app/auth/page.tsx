...
const LoginPage: React.FC = () => {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (loggedIn) {
        // The onAuthStateChange in Providers will handle setting the user,
        // and the root page component will handle redirection.
        router.push('/'); // Redirect to home to trigger dashboard redirect
      }
    } catch (error: any) {
      alert(error.message);
    } finally {
